...
parser.add_argument('--data-dir', default='/media/hznu-303/sdc/gzt/my_project/TreeFormer/londonData', help='data path')
...
parser.add_argument('--batch-size-ul', type=int, default=4, help='train batch size')
parser.add_argument('--device', default='4', help='assign device')
...
parser.add_argument('--run-name', default='Treeformer_FCMS', help='run name for wandb interface/logging')
...
class Trainer(object):
    ...
    def setup(self):
        ...
        self.save_dir = os.path.join("/media/hznu-303/sdc/gzt/my_project/TreeFormer/TreeFormer-main","ckpts", sub_dir)
        ...
        self.model = TCN.pvt_treeformer_fcm(pretrained=False)
